...
import static meqdad.darweesh.homy.ManageActivity.gasSensor;
import static meqdad.darweesh.homy.ManageActivity.CONTROLHOME;
import static meqdad.darweesh.homy.ManageActivity.sensorOff;
            ...
            public void handleMessage(android.os.Message msg) {
                if (msg.what == MESSAGE_READ) {
                    ...
                    try {
                        ...
                        String readMessage2 = msg.obj.toString();
                        if (gasSensor != null) {
                            gasSensor.setText(readMessage + " || " + readMessage2);
                            if (Integer.parseInt(readMessage) > 300)
            ...
            while (true) {
                try {
                    ...
                    if (bytes != 0) {
                        ...
                        bytes = mmInStream.read(buffer, 0, 5); // record how many bytes we actually read
                        mHandler.obtainMessage(MESSAGE_READ, 5, -1, buffer)
